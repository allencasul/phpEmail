# [cakecss-ui](https://github.com/allencasul/cakecss-ui) ![](https://img.shields.io/github/package-json/v/allencasul/cakecss-ui) [![](https://data.jsdelivr.com/v1/package/npm/cakecss-ui/badge)](https://www.jsdelivr.com/package/npm/cakecss-ui) ![](https://img.shields.io/npm/dm/cakecss-ui?color=red&logo=npm) ![Github](https://img.shields.io/github/license/allencasul/cakecss-ui?logo=Github)

<!-- [![Socket Badge](https://socket.dev/api/badge/npm/package/cakecss-ui)](https://socket.dev/npm/package/cakecss-ui) -->

A sweet and lightweight CSS Framework that helps you create web user interfaces in an effortless way. Much more supple, simpler, easy, and beginner-friendly design system.

<a href="https://github.com/allencasul/Cakecss-framework"><img src="https://firebasestorage.googleapis.com/v0/b/rizalcss-framework.appspot.com/o/images%2Fcakecss.png?alt=media&token=0d90cdf8-0545-4c20-92f2-2b411107dd52&_gl=1*1n0xt20*_ga*MjAyNDgxNDIxOC4xNjg2NzE1MzYx*_ga_CW55HF8NVT*MTY4NjcxNzY4MS4yLjEuMTY4NjcxOTE1Ny4wLjAuMA.." alt="Cake CSS Logo" style="max-width:100%;" width="350"></a>
...
```sh
<head>
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/cakecss-ui@1.0.0/css/cdn.Cake.css" integrity="sha256-0vFAs0ft9ykF6DOLV4g0iRVz5hJ+V7HvY5fZapVeUD0=" crossorigin="anonymous">
...
<body>
  ...
  <script defer src="https://cdn.jsdelivr.net/npm/cakecss-ui@1.0.0/js/components.min.js" integrity="sha256-3UCSBV90gv8A+IA1iZst64qLbw7u9y2Y6JbfRa21tKw=" crossorigin="anonymous"></script>
</body>
``` -->
...
<head>
  ...
  <meta name="description" content="Cake CSS Framework, your front-end development partner."/>
  <meta name="keywords" content="Cake CSS Framework, cakecss-ui"/>
  <link rel="stylesheet" href="style.css">
  <script defer src="node_modules/cakecss-ui/js/jquery.min.js"></script>
  <script defer src="https://kit.fontawesome.com/1e8d61f212.js"></script>
  <title>Cake CSS: Modern CSS Framework</title>
</head>
<body>
  ...
  <script defer src="node_modules/cakecss-ui/js/components.min.js"></script>
</body>
</html>
```
...
```sh
/* cakecss-ui | Under MIT License | github.com/allencasul/cakecss-ui */

/*--------- Utilities ---------*/
@import 'node_modules/cakecss-ui/css/utilities/utilities.min.css';

/*--------- Components ---------*/
@import 'node_modules/cakecss-ui/css/components/preloader.css';
@import 'node_modules/cakecss-ui/css/components/app-bar.css';
@import 'node_modules/cakecss-ui/css/components/side-bar.css';
@import 'node_modules/cakecss-ui/css/components/floating-action-button.css';
@import 'node_modules/cakecss-ui/css/components/bottom-navigation-bar.css';
@import 'node_modules/cakecss-ui/css/components/drop-down-menu.css';
@import 'node_modules/cakecss-ui/css/components/alert-dialog.css';
@import 'node_modules/cakecss-ui/css/components/bottom-sheet-dialog.css';
@import 'node_modules/cakecss-ui/css/components/toast.css';
@import 'node_modules/cakecss-ui/css/components/card.css';
@import 'node_modules/cakecss-ui/css/components/input.css';
@import 'node_modules/cakecss-ui/css/components/checkbox.css';
@import 'node_modules/cakecss-ui/css/components/button.css';
@import 'node_modules/cakecss-ui/css/components/stepper.css';
@import 'node_modules/cakecss-ui/css/components/onboarding-screen.css';
@import 'node_modules/cakecss-ui/css/components/table.css';
  ...
  <div class="quinary-preloader-container">
    <div class="quinary-preloader-content-container">
      <div class="quinary-preloader">
        <img class="quinary-pulse-gif" src="https://firebasestorage.googleapis.com/v0/b/cakecss-ui-framework.appspot.com/o/gif%2Fpulse.gif?alt=media&token=1f15f9a5-a6e1-4692-83d5-a91e42b85561">
      </div>
    </div>
  </div>
</div>
  ...
  <div class="tertiary-app-bar-content-container">
    ...
    <div class="tertiary-app-bar-right-container">
      <div class="tertiary-app-bar-right-content-container" id="showDropdownMenuComponent" data-toggle="tooltip" title="Account">
        <img class="tertiary-app-bar-right-content-image" src="https://firebasestorage.googleapis.com/v0/b/cakecss-ui-framework.appspot.com/o/images%2Ffounder.webp?alt=media&token=0ddf5a6d-ebf1-458a-bfbf-99dfe054d512" alt="profile-photo">
      </div>
    </div>
  </div>
</div>
...
<div class="secondary-card-container w_22_rem h_fit_content background_color_white">
  <div class="secondary-card-content-container">
    <div class="secondary-card-top-container">
      <img class="secondary-card-top-image background_color_skeleton" src="https://firebasestorage.googleapis.com/v0/b/cakecss-ui-framework.appspot.com/o/images%2Ffounder.webp?alt=media&token=0ddf5a6d-ebf1-458a-bfbf-99dfe054d512" alt="profile-photo">
      <div class="secondary-card-top-text-icon-container">
        <div class="secondary-card-top-text-container">
          <div class="secondary-card-top-text-title color_black font_size_medium font_weight_600">Cake CSS Framework</div>
...
<div class="secondary-input-container center_absolute w_fit_content h_fit_content background_color_white border_radius_secondary">
  ...
  <form class="w_100_pct h_100_pct display_grid place_content_center" action="#" method="post">
    ...
    <div class="primary-checkbox-container margin_bottom_2_rem">
      ...
      <div class="primary-checkbox-description color_toast font_size_small">I agree to the <a class="font_size_small color_primary" href="https://cakecss-ui.com/privacy-policy" target="_blank">Privacy Policy</a>.</div>
    </div>
...
<div class="primary-checkbox-container">
  ...
  <div class="primary-checkbox-description color_black font_size_small">I agree to the <a class="font_size_small color_primary" href="https://cakecss-ui.com/privacy-policy" target="_blank">Privacy Policy</a>.</div>
</div>
```
...
<div class="primary-onboarding-screen-container" id="firstOnboardingScreen">
  <div class="primary-onboarding-screen-content-container">
    <div class="primary-onboarding-screen-top-content-container text_align_center">
      <img class="primary-onboarding-screen-image w_11_rem margin_bottom_1_rem" src="https://firebasestorage.googleapis.com/v0/b/cakecss-ui-framework.appspot.com/o/svg%2Fbadge.svg?alt=media&token=2b7cb362-2c87-498b-89ef-61cab98799ae" alt="badge">
...
<div class="primary-onboarding-second-screen-container" id="secondOnboardingScreen">
  <div class="primary-onboarding-second-screen-content-container">
    <div class="primary-onboarding-second-screen-top-content-container text_align_center">
      <img class="primary-onboarding-second-screen-image w_11_rem margin_bottom_1_rem" src="https://firebasestorage.googleapis.com/v0/b/cakecss-ui-framework.appspot.com/o/svg%2Fbag.svg?alt=media&token=b468b936-21d9-459e-ae71-d1a624a480c9" alt="bag">
...
<div class="primary-onboarding-third-screen-container" id="thirdOnboardingScreen">
  <div class="primary-onboarding-third-screen-content-container">
    <div class="primary-onboarding-third-screen-top-content-container text_align_center">
      <img class="primary-onboarding-third-screen-image w_11_rem margin_bottom_1_rem" src="https://firebasestorage.googleapis.com/v0/b/cakecss-ui-framework.appspot.com/o/svg%2Fbar.svg?alt=media&token=abf4812d-e082-400d-9c23-8f94816d7516" alt="bar">
...
Copyright holder Allen Charls Casul. Source Code is under [the MIT license](https://github.com/allencasul/cakecss-ui/blob/main/LICENSE).
