# [rizalcss](https://github.com/allencasul/rizalcss-mui) ![](https://img.shields.io/github/package-json/v/allencasul/rizalcss-mui) [![](https://data.jsdelivr.com/v1/package/npm/rizalcss-mui/badge)](https://www.jsdelivr.com/package/npm/rizalcss-mui) ![](https://img.shields.io/npm/dm/rizalcss-mui?color=red&logo=npm) [![Socket Badge](https://socket.dev/api/badge/npm/package/rizalcss-mui)](https://socket.dev/npm/package/rizalcss-mui) ![](https://img.shields.io/github/repo-size/allencasul/rizalcss-mui?color=blueviolet&logo=Github&style=plastic) ![Github](https://img.shields.io/github/license/allencasul/rizalcss-mui?logo=Github)

A lightweight CSS Framework that helps you create web user interfaces in an effortless way. Much more supple, simpler, easy, and beginner-friendly design system.

<a href="https://github.com/allencasul/rizalcss-framework"><img src="https://firebasestorage.googleapis.com/v0/b/rizalcss-framework.appspot.com/o/images%2Frizalcss-logo.webp?alt=media&token=c6fdf722-aa09-4c49-a780-644b6e597c66" alt="Rizal CSS Logo" style="max-width:100%;" width="600"></a>


## Installation

Installing Rizal CSS
...
```sh
<head>
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/rizalcss-mui@1.0.0/css/cdn.rizal.css" integrity="sha256-0vFAs0ft9ykF6DOLV4g0iRVz5hJ+V7HvY5fZapVeUD0=" crossorigin="anonymous">
...
<body>
  ...
  <script defer src="https://cdn.jsdelivr.net/npm/rizalcss-mui@1.0.0/js/components.min.js" integrity="sha256-3UCSBV90gv8A+IA1iZst64qLbw7u9y2Y6JbfRa21tKw=" crossorigin="anonymous"></script>
</body>
```
...
<head>
  ...
  <meta name="description" content="Rizal CSS Framework, your front-end development partner."/>
  <meta name="keywords" content="Rizal CSS Framework, rizalcss"/>
  <link rel="stylesheet" href="style.css">
  <script defer src="node_modules/rizalcss/js/jquery.min.js"></script>
  <script defer src="https://kit.fontawesome.com/1e8d61f212.js"></script>
  <title>Rizal CSS: Modern CSS Framework</title>
</head>
<body>
  ...
  <script defer src="node_modules/rizalcss/js/components.min.js"></script>
</body>
</html>
```
...
```sh
/* rizalcss | Under MIT License | github.com/allencasul/rizalcss */

/*--------- Utilities ---------*/
@import 'node_modules/rizalcss/css/utilities/utilities.min.css';

/*--------- Components ---------*/
@import 'node_modules/rizalcss/css/components/preloader.css';
@import 'node_modules/rizalcss/css/components/app-bar.css';
@import 'node_modules/rizalcss/css/components/side-bar.css';
@import 'node_modules/rizalcss/css/components/floating-action-button.css';
@import 'node_modules/rizalcss/css/components/bottom-navigation-bar.css';
@import 'node_modules/rizalcss/css/components/drop-down-menu.css';
@import 'node_modules/rizalcss/css/components/alert-dialog.css';
@import 'node_modules/rizalcss/css/components/bottom-sheet-dialog.css';
@import 'node_modules/rizalcss/css/components/toast.css';
@import 'node_modules/rizalcss/css/components/card.css';
@import 'node_modules/rizalcss/css/components/input.css';
@import 'node_modules/rizalcss/css/components/checkbox.css';
@import 'node_modules/rizalcss/css/components/button.css';
@import 'node_modules/rizalcss/css/components/onboarding-screen.css';
@import 'node_modules/rizalcss/css/components/table.css';
  ...
  <div class="quinary-preloader-container">
    <div class="quinary-preloader-content-container">
      <div class="quinary-preloader">
        <img class="quinary-pulse-gif" src="https://firebasestorage.googleapis.com/v0/b/rizalcss-framework.appspot.com/o/gif%2Fpulse.gif?alt=media&token=1f15f9a5-a6e1-4692-83d5-a91e42b85561">
      </div>
    </div>
  </div>
</div>
  ...
  <div class="tertiary-app-bar-content-container">
    ...
    <div class="tertiary-app-bar-right-container">
      <div class="tertiary-app-bar-right-content-container" id="showDropdownMenuComponent" data-toggle="tooltip" title="Account">
        <img class="tertiary-app-bar-right-content-image" src="https://firebasestorage.googleapis.com/v0/b/rizalcss-framework.appspot.com/o/images%2Ffounder.webp?alt=media&token=0ddf5a6d-ebf1-458a-bfbf-99dfe054d512" alt="profile-photo">
      </div>
    </div>
  </div>
</div>
...
<div class="secondary-card-container w_22_rem h_fit_content background_color_white">
  <div class="secondary-card-content-container">
    <div class="secondary-card-top-container">
      <img class="secondary-card-top-image background_color_skeleton" src="https://firebasestorage.googleapis.com/v0/b/rizalcss-framework.appspot.com/o/images%2Ffounder.webp?alt=media&token=0ddf5a6d-ebf1-458a-bfbf-99dfe054d512" alt="profile-photo">
      <div class="secondary-card-top-text-icon-container">
        <div class="secondary-card-top-text-container">
          <div class="secondary-card-top-text-title color_black font_size_medium font_weight_600">Rizal CSS Framework</div>
...
<div class="secondary-input-container center_absolute w_fit_content h_fit_content background_color_white border_radius_secondary">
  ...
  <form class="w_100_pct h_100_pct display_grid place_content_center" action="#" method="post">
    ...
    <div class="primary-checkbox-container margin_bottom_2_rem">
      ...
      <div class="primary-checkbox-description color_toast font_size_small">I agree to the <a class="font_size_small color_primary" href="https://rizalcss.com/privacy-policy" target="_blank">Privacy Policy</a>.</div>
    </div>
...
<div class="primary-onboarding-screen-container" id="firstOnboardingScreen">
  <div class="primary-onboarding-screen-content-container">
    <div class="primary-onboarding-screen-top-content-container text_align_center">
      <img class="primary-onboarding-screen-image w_11_rem margin_bottom_1_rem" src="https://firebasestorage.googleapis.com/v0/b/rizalcss-framework.appspot.com/o/svg%2Fbadge.svg?alt=media&token=2b7cb362-2c87-498b-89ef-61cab98799ae" alt="badge">
...
<div class="primary-onboarding-second-screen-container" id="secondOnboardingScreen">
  <div class="primary-onboarding-second-screen-content-container">
    <div class="primary-onboarding-second-screen-top-content-container text_align_center">
      <img class="primary-onboarding-second-screen-image w_11_rem margin_bottom_1_rem" src="https://firebasestorage.googleapis.com/v0/b/rizalcss-framework.appspot.com/o/svg%2Fbag.svg?alt=media&token=b468b936-21d9-459e-ae71-d1a624a480c9" alt="bag">
...
<div class="primary-onboarding-third-screen-container" id="thirdOnboardingScreen">
  <div class="primary-onboarding-third-screen-content-container">
    <div class="primary-onboarding-third-screen-top-content-container text_align_center">
      <img class="primary-onboarding-third-screen-image w_11_rem margin_bottom_1_rem" src="https://firebasestorage.googleapis.com/v0/b/rizalcss-framework.appspot.com/o/svg%2Fbar.svg?alt=media&token=abf4812d-e082-400d-9c23-8f94816d7516" alt="bar">
...
Just visit the link for the utilities [Click here](https://rizalcss.com/utilities/).

## Licensing

Copyright holder Allen Charls Casul. Source Code is under [the MIT license](https://github.com/allencasul/rizalcss/blob/main/LICENSE).
